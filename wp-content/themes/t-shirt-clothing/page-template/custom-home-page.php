          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption slider-inner">
              ...
              <div class="home-btn my-4">
                <a class="py-3 px-4" href="<?php the_permalink(); ?>"><i class="fas fa-shopping-cart mr-2"></i><?php echo esc_html('Shop Now','t-shirt-clothing'); ?></a>
              </div>
            </div>
          </div>
          <?php $i++; endwhile;
          ...
          <div class="col-lg-5 col-md-6 col-sm-6 align-self-center">
            <?php if( get_theme_mod('clothing_store_millions_of_hours_countdown_timer') != '' ){ ?>
              <div id="countdown-timer" class="text-center">
                ...
                <div class="time-box mr-2 mr-lg-3"><strong id="days" class="bold-number">118 </strong> <p class="slim-countdown-text mb-0"><?php esc_html_e('Days','t-shirt-clothing'); ?></p><span class="timer"></span></div>
                <div class="time-box mr-2 mr-lg-3"><strong id="hours" class="bold-number"> 14 </strong> <p class="slim-countdown-text mb-0"><?php esc_html_e('Hours','t-shirt-clothing'); ?></p><span class="timer"></span></div>
                <div class="time-box mr-2 mr-lg-3"><strong id="mins" class="bold-number"> 36 </strong> <p class="slim-countdown-text mb-0"><?php esc_html_e('Minutes','t-shirt-clothing'); ?></p><span class="timer"></span></div>
